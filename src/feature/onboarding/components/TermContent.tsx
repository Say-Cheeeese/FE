    ...
    <div className='flex flex-col gap-8'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='text-xs leading-[18px] font-normal text-[#747681]'>
          회사는 URL 또는 QR 코드를 통해 사진을 공유할 수 있는 웹 기반 앨범
          서비스를 제공합니다.
          <br />
          해당 서비스는 다음과 같은 기능을 포함합니다.
          <br />- 회원은 로그인 인증 절차를 완료한 경우에 한하여 앨범에 참여할
          수 있으며, 참여자는 앨범 내에서 사진을 업로드하고 열람할 수 있습니다.
          <br />- 앨범은 생성 시 설정된 기간(기본 약 7일) 동안 활성화되며, 기간
          종료 시 자동으로 종료됩니다. 종료된 앨범의 콘텐츠는 삭제되거나 접근이
          제한될 수 있습니다.
          <br />- 하나의 앨범에는 서비스 가용 용량에 따라 참여 인원이 제한될 수
          있으며, 해당 범위 내에서 다수의 사용자가 동시에 이용할 수 있습니다.
          <br />- 회사는 서비스 이용과 관련하여 필요한 경우 전자적 수단(카카오
          알림톡 등)을 통해 회원에게 주요 사항(앨범 참여, 콘텐츠 생성, 만료 예정
          등)을 안내할 수 있으며, 이는 서비스 제공을 위한 필수적인 안내에
          해당합니다.
        </div>
      </div>
      <div className='flex flex-col gap-1'>
