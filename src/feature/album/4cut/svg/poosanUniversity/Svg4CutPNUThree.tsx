...
function applyPnuThreeTemplateIds(
  markup: string,
  ids: {
    clipId: string;
    patternBgId: string;
...
export default function Svg4CutPNUThree({
  ...
  const innerHtml = applyPnuThreeTemplateIds(PNU_THREE_INNER_AFTER_PHOTOS, ids);
  const defsHtml = applyPnuThreeTemplateIds(PNU_THREE_DEFS, ids);
