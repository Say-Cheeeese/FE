...
export interface FourCutPreviewFramePNUFiveProps {
  widthPx: number;
  eventName?: string;
  eventDate?: string;
  isFinalized?: boolean;
...
/** 부산대(PNU) 네컷 템플릿 5 — (`Svg4CutPNUFive` 와 짝) */
export default function FourCutPreviewFramePNUFive({
  widthPx,
  eventName,
  eventDate,
  isFinalized = false,
  children,
}: FourCutPreviewFramePNUFiveProps) {
