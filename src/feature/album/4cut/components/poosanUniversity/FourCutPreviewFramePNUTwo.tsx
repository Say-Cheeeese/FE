...
export interface FourCutPreviewFramePNUTwoProps {
  widthPx: number;
  eventName?: string;
  eventDate?: string;
  isFinalized?: boolean;
...
/**
 * 부산대(PNU) 네컷 템플릿 2 — 레이아웃·타이포
 * (`Svg4CutPNUTwo` 와 짝)
 */
export default function FourCutPreviewFramePNUTwo({
  widthPx,
  eventName,
  eventDate,
  isFinalized = false,
  children,
}: FourCutPreviewFramePNUTwoProps) {
