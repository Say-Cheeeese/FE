...
export interface FourCutPreviewFramePNUFourProps {
  widthPx: number;
  eventName?: string;
  eventDate?: string;
  isFinalized?: boolean;
...
/** 부산대(PNU) 네컷 템플릿 4 — (`Svg4CutPNUFour` 와 짝) */
export default function FourCutPreviewFramePNUFour({
  widthPx,
  eventName,
  eventDate,
  isFinalized = false,
  children,
}: FourCutPreviewFramePNUFourProps) {
