...
export const EP = {
  ...
  album: {
    "create": () => `/v1/album`,
    "availableCount": (code: string | number) => `/v1/album/${code}/available-count`,
    "albumBest-4cut": (code: string | number) => `/v1/album/${code}/best-4cut`,
    "albumBlacklist": (code: string | number, targetUserId: string | number) => `/v1/album/${code}/blacklist/${targetUserId}`,
    "enter": (code: string | number) => `/v1/album/${code}/enter`,
    "albumInfo": (code: string | number) => `/v1/album/${code}/info`,
    "invitation": (code: string | number) => `/v1/album/${code}/invitation`,
    "participants": (code: string | number) => `/v1/album/${code}/participants`,
    "albumParticipantsMe": (code: string | number) => `/v1/album/${code}/participants/me`,
    "albumPhoto": (code: string | number, photoId: string | number) => `/v1/album/${code}/photo/${photoId}`,
    "photos": (code: string | number) => `/v1/album/${code}/photos`,
    "photoDetail": (code: string | number, photoId: string | number) => `/v1/album/${code}/photos/${photoId}`,
    "albumPhotosLikers": (code: string | number, photoId: string | number) => `/v1/album/${code}/photos/${photoId}/likers`,
    "likedPhotos": (code: string | number) => `/v1/album/${code}/photos/liked`,
    "albumClosed": () => `/v1/album/closed`,
    "albumOpen": () => `/v1/album/open`,
    "albumOpenMe": () => `/v1/album/open/me`,
  },
  photo: {
    "like": (photoId: string | number) => `/v1/photo/${photoId}/liked`,
    "unlike": (photoId: string | number) => `/v1/photo/${photoId}/unliked`,
...
export interface UserInfoResponseSchema { "userId": number; "profileImage": string; "email": string; "name": string; "albumCount": number; "photoCount": number; "likesCount": number; "phoneNumber"?: string; }
...
export interface PhotoListResponseSchema { "name"?: string; "photoId": number; "uploaderId"?: number; "profileImage": string; "imageUrl"?: string; "thumbnailUrl": string; "likeCnt": number; "isLiked": boolean; "isDownloaded": boolean; "isRecentlyDownloaded": boolean; "canDelete": boolean; "isMine"?: boolean; }
