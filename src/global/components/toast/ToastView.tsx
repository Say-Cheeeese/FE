...
export default function ToastView({ lucideIcon, message }: ToastViewProps) {
  return (
    <div className='bg-surface-info pointer-events-none fixed bottom-[84px] left-1/2 z-999 flex h-14 w-[calc(100%-32px)] max-w-[430px] -translate-x-1/2 items-center rounded-[8px] px-5 transition-opacity duration-400'>
